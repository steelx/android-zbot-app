...
import 'package:zbot_app/auth/http_exception.dart';
...
class _AuthCardState extends State<AuthCard> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _slideAnimation = Tween<Offset>(begin: Offset(0, -1.5), end: Offset(0, 0)).animate(
      CurvedAnimation(parent: _controller, curve: Curves.linearToEaseOut, reverseCurve: Curves.easeInToLinear),
    );
  ...
  Future<void> _submit() async {
    ...
    try {
      if (_authMode == AuthMode.Login) {
        await Provider.of<Auth>(context, listen: false).signin(_authData['username'], _authData['password']);
      } else {
